$(function(){
	...
	var questions = [
		...
		new Question('이정우목사님 친할머니의 국적은?', ['튀르키예','고려','중국','한국'],'한국'),
		new Question('예배 전 중보기도모임 장소는 어디인가요?', ['샬롬홀','비전홀','비전센터','청년부 스튜디오'],'청년부 스튜디오'),
		new Question('내수동교회 카페 이름은?', ['쉴만한물가','베들레헴','에덴동산','광야의하루'],'쉴만한물가'),
		new Question('본당(본관)까지 올라가는 계단 갯수는?', ['21개','22개','23개','108개'],'22개'),
